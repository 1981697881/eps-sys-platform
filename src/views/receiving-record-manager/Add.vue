        ...
        <el-form  :inline="true" :model="formData" :rules="rules" ref="form" label-width="130px">
            ...
            <el-row>
                <el-form-item class="search-form-item" label="寄件人地区">
                    <el-cascader placeholder="请选择寄件人地区" v-model="formData.senderAreas" style="width: 544px"  :props="area"></el-cascader>
                </el-form-item>
            </el-row>
            <el-row>
            ...
            <el-row>
                <el-form-item class="search-form-item" label="收件人地区">
                    <el-cascader placeholder="请选择收件人地区" v-model="formData.addresseeAreas" style="width: 544px"  :props="area"></el-cascader>
                </el-form-item>
            </el-row>
            <el-row>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                api: {
                    add: this.$api.receivingRecord.add
                },
                formErrorMsg: {},
                formData: {
                    receivingMethod: '',
        ...
        methods: {
            ...
            handleSubmit(form)
            {
                ...
                vm.$refs[form].validate((valid) => {
                    if (this.formData.senderAreas.length < 1) {
                        vm.$message({
                            type: "error",
                            message: "请选择寄件人地区！"
                        });
                    ...
                    if (this.formData.addresseeAreas.length < 1) {
                        vm.$message({
                            type: "error",
                            message: "请选择收件人地区！"
                        });
                    ...
                    if (valid) {
                        vm.$http.post(vm.api.add, vm.$qs.stringify({
                            ...
                            senderAreaNumber: this.formData.senderAreas[this.formData.senderAreas.length - 1],
                            addressee: this.formData.addressee,
                            addresseeMobileNumber: this.formData.addresseeMobileNumber,
                            addresseeAreaNumber: this.formData.addresseeAreas[this.formData.addresseeAreas.length - 1],
