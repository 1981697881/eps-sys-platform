...
<!--            <el-button icon="el-icon-plus" @click="$router.push('add')">新增</el-button>-->
        ...
        <template slot="search-form">
            ...
            <el-form-item class="search-form-item" label="揽件类型">
                <el-select v-model="searchForm.type" placeholder="请选择揽件类型">
                    <el-option label="全部" value=""></el-option>
                    <el-option label="系统件" value="SYSTEM"></el-option>
                    <el-option label="自揽件" value="EMPLOYEE_SELF"></el-option>
                </el-select>
            </el-form-item>
        ...
        <template slot="table">
            ...
            <el-table :data="tableData" @selection-change="handleSelectionChange" @row-dblclick="handleEdit">
                ...
                >
                    <template scope="scope">
                        {{scope.row.type === 'SYSTEM'?(scope.row.receivingMethod ? getReceivingMethodName(scope.row.receivingMethod ) :'-'):'-' }}
                    </template>
                </el-table-column>
                ...
                >
                    <template scope="scope">
                        ...
                        {{scope.row.type === 'SYSTEM'?(($moment(scope.row.receivingStartTime).format('HH:mm:ss')) + ' - ' + $moment(scope.row.receivingEndTime).format('HH:mm:ss')):'-'}}
                    </template>
                </el-table-column>
