        ...
        <el-form :inline="true" :model="formData" :rules="rules" ref="form" label-width="130px">
            <el-row>
                <el-form-item label="揽件方式：">
                    <div class="width180">
                        {{getReceivingMethodName(formData.receivingMethod)}}
                    </div>
                </el-form-item>
            ...
            <el-row>
                <el-form-item label="寄件人地址：">
                    {{formData.senderAreaName + formData.senderAddress}}
                </el-form-item>
            </el-row>
            <el-row>
            ...
            <el-row>
                <el-form-item label="收件人详细地址：">
                    {{formData.addresseeAreaName + formData.senderAddress}}
                </el-form-item>
            </el-row>
            ...
            <el-row>
                <el-form-item class="search-form-item" label="揽件时段:">
                    <div class="width180">
                        {{$moment(formData.receivingStartTime).format('HH:mm:ss') + ' - ' +
                        $moment(formData.receivingEndTime).format('HH:mm:ss')}}
                    </div>

                </el-form-item>
                <el-form-item label="物品重量(Kg)：">
                    <div class="width180"> {{formData.weight}}</div>
                </el-form-item>
            </el-row>
            <el-row>
            ...
            <el-row>
                ...
                <el-form-item label="快递费用（¥）：">
                    <div class="width180">{{formData.budget}}</div>
                </el-form-item>
                ...
                <el-form-item label="揽件记录：">
                    <div v-if="formData.receivingHistory && formData.receivingHistory.length > 0">
                        <div v-bind:key="index" v-for="(h,index) in formData.receivingHistory">
                            <span>{{ h.time | dateFormat("yyyy-MM-dd hh:mm:ss") }}</span>
