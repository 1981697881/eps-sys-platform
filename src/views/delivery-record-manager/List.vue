<template>
    ...
    >
        ...
        <template slot="btn-group">
            <el-button icon="el-icon-check" @click="handleBatchVerify">快件核销</el-button>
            ...
            <el-button icon="el-icon-tickets" @click.stop="handleAllExport()">配送件导出</el-button>
            <el-button icon="el-icon-tickets" @click.stop="handleImportVerify()">批量导入核销</el-button>
            <!-- 文件上传 -->
            <input hidden type="file" class="file" ref="handleImportVerifyFile" @change="changeImportVerifyFile">
        </template>
        ...
        <template slot="search-form">
            ...
            <el-form-item class="search-form-item" label="核销状态">
                <el-select v-model="searchForm.verifyState" placeholder="请选择核销状态">
                    <el-option label="全部" value=""></el-option>
                    <el-option v-bind:key="item.value" v-for="item in verifyStates" :label="item.name"
            ...
            <el-form-item class="search-form-item" label="快递厂商">
                <el-select v-model="searchForm.business" placeholder="请选择快递厂商">
                    <el-option label="全部" value=""></el-option>
                    <el-option v-bind:key="item.value" v-for="item in businesses" :label="item.name"
                               :value="item.value"></el-option>
                </el-select>
            </el-form-item>
            ...
            <el-table :data="tableData" @selection-change="handleSelectionChange" @row-dblclick="handleEdit">
                ...
                <el-table-column
                    ...
                    <template slot-scope="scope">
                        <el-link style="margin-left: 10px;" type="primary" @click="handleVerifyState(scope.$index)"
                                 :underline="false">核销
                        </el-link>
                        <el-link style="margin-left: 10px;" type="primary" @click="handleDetail(scope.row)"
                                 :underline="false">详情
                        </el-link>
                        <el-link type="danger" @click="handleDelete(scope.row)" :underline="false"
        ...
        data() {
            return {
                api: {
                    ...
                    export: this.$api.deliveryRecord.export,
                    importVerify: this.$api.deliveryRecord.importVerify,
